		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Shipping Charge(estimated transport)</th>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "KSH."." ".$row['productPrice']; ?>KSH.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "KSH"." ".$row['shippingCharge']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>KSH.00</span></td>
				</tr>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						 Total<span class="inner-left-md"><?php echo $_SESSION['tp']="KSH.00"."$totalprice"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
