...
<h3>UZIMA ONLINE STORE</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us">JOIN US TODAY AND ENJOY QUICK AND AFFORDABLE SHOPPING . QUICK DELIVERIES COUNTRYWIDE .</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>+254 797 907 371<br>(011) 000000000000</p>
                </div>
            </li>
